    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <div className="flex mt-5 space-x-6 text-gray-600">
          <a className="hover:opacity-75"  target="_blank" href='https://www.facebook.com/profile.php?id=61555184729804'>
          ...
          <a className="hover:opacity-75"  target="_blank" href='https://www.instagram.com/lux_craftdecor/'>
