          ...
          <div className="">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                ...
                <div className="relative hidden lg:flex items-center ml-20 mr-20 w-[500px] ">
                        ...
                        <input
                            ...
                            className="px-10 py-3 w-full border-2 border-black rounded focus:outline-none focus:ring-2 focus:ring-blue-500  outline-2 text-base"
                            style={{
                     ...
                     <div className="bg-yellow-400 flex items-center m-[-42px] w-[40px] py-[11px] ">
